...
import arquitectura.proyecto.android.appsgpl.models.Download;
...
public class DownloadService extends IntentService {
    ...
    private void initDownload(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://proyectos2017.esy.es/HOME-CONTENT/servicios/archivos/")
                .build();

        APIService retrofitInterface = retrofit.create(APIService.class);

        Call<ResponseBody> request = retrofitInterface.downloadFile(doc);
        try {
    ...
    private void downloadFile(ResponseBody body) throws IOException {
        ...
        File outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),doc);
